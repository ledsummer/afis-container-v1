<?php 
  /* Template Name: NEW CTPRO ACCOUNT REGISTRATION */ 
  get_header(); 
  acf_form_head();
  ?>
<div  class="site-main">
    <div class="container">
        <?php if(($_GET['token']) && ($_GET['edit'] == '')){
            $token=$_GET['token']; ?>
            ...
            <div class="standardCenter-registration review">
                ...
                <div class="cea-registration">
                    ...
                    <div class="action-buttons">
                        <a id="btnBack" class="action-btn btn-back" href="<?php echo home_url(); ?>/ctpro-online-registration/?edit=<?php echo get_the_id(); ?>&token=<?php echo $token; ?>">Back</a>
                        <a id="btnSubmit" class="action-btn btn-submit">Submit</a>
                    </div>
                    <script> document.getElementById("acf-field_61cd2c4ef0295").value = "<?php echo $confirmationkey; ?>"; </script>
                </div>
            </div>
            <div class="clear"></div>
   ...
   document.getElementById("registrationform").style.display = "none";
    ...
    <form action="../process-ctpro.php" id="validate" style="padding:0 10px; ">
    <div class="validationBox">
    <div class="validation-title">If you have existing data as CTPro, please enter your CTPro registered Name (Case sensitive):</div>
 ...
 <div id="result" style="margin-top: 2em;"></div>
          ...
          <div id="registrationform">
                    ...
                    ?>
                    <script>
                        document.getElementById("acf-field_61cd2c4eef8fa").value = "<?php echo $txnid; ?>";
                    </script>
                </div>
            </div>
             </div>
