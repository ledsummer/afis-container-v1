<?php
/* Template Name: Accreditation Requests */
get_header();
acf_form_head();
?>
...
<div class="headerAccount"><i class="fas fa-file-alt"></i> Accreditation Requests</div>
   ...
   <div class="tabs">
    ...
    <div class="tab">
      ...
      <div class="clear"></div>
       <br><br>
       <?php include( get_template_directory() . '-child/officials/accreditation-requests/approved-requests.php' ); ?>
    ...
    <div class="tab">
     <div class="col-mid-80"><h1>All Deferred Applications</h1></div>  
      <div class="clear"></div>
       <br><br>
      <?php include( get_template_directory() . '-child/officials/accreditation-requests/deferred-request.php' ); ?>
    </div>
