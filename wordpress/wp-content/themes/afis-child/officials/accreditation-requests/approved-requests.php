<?php
//Approved Accreditation Requests
...
<table id="customersApproved" class="customers">
    <thead>
          <tr>
        ...
        if ($variable->have_posts()): the_post(); ?>
            <?php while( $variable->have_posts() ): $variable->the_post(); ?>
               ...
               <tr>
                    ...
                    <td>
                        <?php if(get_field('upload_certificate') != '') { ?>
                            <a href="<?php echo get_field('upload_certificate')['url']; ?>" target="_new">Uploaded</a>
                        <?php } else { ?>
                            Not yet uploaded
                        <?php } ?>
                    </td>
                    ...
                    <td style="text-align:center;"> <a href="../view-accreditation-request?post_id=<?php echo $cpost; ?>&acc_id=<?php echo get_the_id(); ?>" style="color:inherit;" target="_new">View Application</a>   </td>
                </tr>
            <?php endwhile; ?>
        <?php else : ?>
