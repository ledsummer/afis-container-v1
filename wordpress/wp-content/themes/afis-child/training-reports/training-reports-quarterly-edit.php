<?php
/* Template Name: Edit Quarterly Training Reports*/
get_header();
acf_form_head();
?>
...
<div class="headerAccount"><i class="fas fa-file-alt"></i> Submit your Training Reports</div>
  <?php
...
You have successfully edited your training reports
 ...
 <?php include( get_template_directory() . '-child/training-reports/training-reports-quarterly-edit.php' ); ?>
<?php
}
else
{
