<?php
/* Template Name: Monthly Training Reports Submission */
get_header();
acf_form_head();
?>
...
<div class="headerAccount"><i class="fas fa-file-alt"></i> Submit your Monthly Training Report</div>
  <?php
    ...
    if (have_posts()):
        while (have_posts()):
            ...
            acf_form(array(
                'post_id' => 'new_post',
                'field_groups' => array(
                    'group_61d28d3f0ba66',  // Monthly Report
...
?>
            ...
            <script>
                document.getElementById("acf-field_61d3ed21a1982").value = "<?php echo $name; ?>";
                document.getElementById("acf-field_61d3dd31019a6").value = "<?php echo $ca; ?>";
                document.getElementById("acf-field_61d3dccf019a4").value = "<?php echo $cpost; ?>";
