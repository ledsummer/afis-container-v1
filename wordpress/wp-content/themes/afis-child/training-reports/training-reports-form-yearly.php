<?php
/* Template Name: Yearly Training Reports Submission */
get_header();
acf_form_head();
?>
...
<div class="headerAccount"><i class="fas fa-file-alt"></i> Submit your Yearly Training Report</div>
  <?php
if (isset($_GET['success']))
{
?>
<div class="info-success">
You have successfully submitted your yearly training report
</div>
<div class="no-tabs">
    ...
    if (have_posts()):
        while (have_posts()):
            ...
            acf_form(array(
                'post_id' => 'new_post',
                'field_groups' => array(
                    'group_61d3b5b8ee056',  // Yearly Report
...
?>
                ...
                <script>
                document.getElementById("acf-field_61d3b9a8446cb").value = "<?php echo $name; ?>";
                document.getElementById("acf-field_61d3b9a0446ca").value = "<?php echo $cpost; ?>";
