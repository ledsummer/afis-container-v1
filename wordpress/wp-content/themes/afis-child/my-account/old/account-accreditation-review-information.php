...
if ($variable1->have_posts()): the_post(); ?>
    <?php while( $variable1->have_posts() ): $variable1->the_post();
        ...
        <div class="account-information">
            ...
            <!--<div class="label-information">Application No:</div> <div class="data-information"><?php echo get_field('ca-no'); ?></div>-->
            <!--<div class="clear"></div>-->
            ...
            <div class="label-information">Application:</div><div class="data-information">Renewal</div>
			<div class="clear"></div>
