<?php
/* Template Name: Training Requirements */
get_header();
acf_form_head();
?>
...
<div class="headerAccount"><i class="fas fa-certificate"></i> My Documentary Requirements</div>
   ...
   <div class="tabs">
    ...
    <div class="tab">
      <div class="col-mid-80"><h1></h1></div>  <div class="col-mid-20" style="text-align:right;">
          <a href="training-documents-submission/" class="nextbtn" target="_blank"><button>Add New</button></a></div>
